...
public class VacuumCleanerValidator {
    public static boolean validate(Criteria criteria) {
        ...
        if (vacuumCleanerParameters.containsKey(POWER_CONSUMPTION.toString())) {
            int powerConsumption = (int) vacuumCleanerParameters.get(POWER_CONSUMPTION.toString());
            return powerConsumption >= 90 && powerConsumption <= 120;
        } else if (vacuumCleanerParameters.containsKey(FILTER_TYPE.toString())) {
            String filterType = (String) vacuumCleanerParameters.get(FILTER_TYPE.toString());
            ...
            String bagType = (String) vacuumCleanerParameters.get(BAG_TYPE.toString());
            ...
            String wandType = (String) vacuumCleanerParameters.get(WAND_TYPE.toString());
            return wandType.equals("all-in-one");
        } else if (vacuumCleanerParameters.containsKey(MOTOR_SPEED_REGULATION.toString())) {
            int motorSpeedRegulation = (int) vacuumCleanerParameters.get(MOTOR_SPEED_REGULATION.toString());
            ...
            int cleaningWidth = (int) vacuumCleanerParameters.get(CLEANING_WIDTH.toString());
